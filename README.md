...
- [Blog @ virantha.com](http://virantha.com/category/pypdfocr.html)
...
the [xpdf](http://www.foolabs.com/xpdf/download.html) or poppler packages.
...
** Important ** Tesseract version 3.02.02 or newer required (apparently 3.02.01-6 and possibly others do not work due to a hocr output format change that I'm not planning to address).  On Ubuntu, you may need to
compile and install it manually by following [these instructions](http://miphol.com/muse/2013/05/install-tesseract-ocr-on-ubunt.html)
